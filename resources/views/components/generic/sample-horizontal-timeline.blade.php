...
<section class="pt-28 w-full md:w-10/12 mx-auto">

    <!-- This component will maintain responsiveness and its columns -->
    <!-- It will wrap to new line once the column of a row have been filled -->
    <ol class="items-center md:flex md:flex-wrap">
        <li class="relative mb-6 sm:mb-0 w-full md:w-4/12 p-2">
            <!-- Icon & gray lne -->
