<div id="toast-default" class="flex items-center p-4 w-full text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 {{$classes = 'fixed bottom-0'}}" role="alert" style="direction: ltr">
